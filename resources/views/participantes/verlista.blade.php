                ...
                @forelse($estudiantes as $participante)
                    <tr>
                        ...
                        <td>
                            ...
                            <!---------------pdf---------------------------->
                            <!---------------30-01-2023---------------------->
                            <a href="{{route('pdf', ['id'=>$participante->ci,'pid'=>$programa->id])}}" target="_blank" class="btn btn-warning">
                                <i class="fas fa-file-pdf "></i>
                            </a>
                            <a href="{{route('pdfcarta', ['id'=>$participante->ci,'pid'=>$programa->id])}}" target="_blank" class="btn btn-primary">
                                <i class="fas fa-file-pdf "></i>
                            </a>
                            <!----------------------------------->
                        </td>
